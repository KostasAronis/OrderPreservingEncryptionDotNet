...
namespace OrderPreservingEncryptionDotNet
{
    ...
    {
        public static long SampleUniform(ValueRange valueRange, IEnumerator<bool> coins)
        {
         ...
         */
        internal static long SampleHGD(ValueRange inRange, ValueRange outRange, long mid, IEnumerator<bool> coins)
        {
        ...
        /*
            ...
            and nn2 black balls.
        */
        private static double RHyper(long kk, double nn1, double nn2, IEnumerator<bool> coins)
        {
...
private static double LogGamma(double x)
{
    ...
    public class PRNG
    {
        ...
        public PRNG(IEnumerator<bool> coins)
        {
            _coins = coins;
        }
        public double Draw()
